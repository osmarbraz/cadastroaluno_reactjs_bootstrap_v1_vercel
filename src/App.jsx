...
const endereco_servidor = "https://cadastroaluno-nodejs-v1-vercel.vercel.app";
  ...
  return (
    <>      
      <Form name="FrmCadastroAluno" method="post" onSubmit={alterarId < 0 ? handleSubmitInsert: handleSubmitUpdate}>
        ...
        <Form.Group>
          <Form.Label>AlunoId: 
          <Form.Control type="number" size="10" name="alunoId" value={alunoId} onChange={(event) => setAlunoId(event.target.value)}/></Form.Label><br/>
          <Form.Label>Nome: 
          <Form.Control type="text" size="60" id="nome" name="nome" value={nome} onChange={(event) => setNome(event.target.value)} /></Form.Label><br/>
          <Form.Label>Curso: 
          <Form.Control type="text" size="60" id="curso" name="curso" value={curso} onChange={(event) => setCurso(event.target.value)} /></Form.Label><br/>
          <Form.Label>CPF: 
